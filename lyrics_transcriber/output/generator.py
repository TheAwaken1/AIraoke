...
class OutputGenerator:
    ...
    def __init__(
        ...
        if self.config.render_video:
            ...
            if self.preview_mode:
                ...
                if "karaoke" in self.config.styles and "font_size" in self.config.styles["karaoke"]:
                    ...
                    if original_font_size is not None:
                        # Scale down from 4K (2160p) to 360p - factor of 1/6
                        self.font_size = int(original_font_size) * scale_factor
            ...
            self.subtitle = SubtitlesGenerator(
                ...
                font_size=int(self.font_size),  # Ensure font_size is an integer
    ...
    def generate_outputs(
        ...
        try:
            ...
            if transcription_corrected:
                ...
                if self.preview_mode:
                    # Use audio_filepath as output_prefix to ensure FFprobe works
                    outputs.ass = self.subtitle.generate_ass(transcription_corrected.resized_segments, audio_filepath, audio_filepath)
                    # Use the correct output_prefix for the video file name
                ...
                if self.config.render_video:
                    # Use audio_filepath as output_prefix to ensure FFprobe works
                    outputs.ass = self.subtitle.generate_ass(resized_segments, audio_filepath, audio_filepath)
                    # Use the correct output_prefix for the video file name
    ...
    def _get_video_params(self, resolution: str) -> tuple:
        ...
        # Convert font_size to integer if it's a string
